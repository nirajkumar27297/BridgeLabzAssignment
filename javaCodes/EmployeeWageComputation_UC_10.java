...
{   
   ...
   private ArrayList CompanyWageList;
    ...
    {
    CompanyEmpWage_Obj=new  CompanyEmpWage(Company,wagePerHour,numberOfDays,numberOfDays);
    ...
    private void computeEmpWage()
    {
        ...
        {   double totalWage=computeEmpWageHelper(CompanyWageList.get(i));
            CompanyEmpWage_Array.get(i).settotalWage(totalWage);
			System.out.println(CompanyEmpWage_Array.get(i));
        }
    }
